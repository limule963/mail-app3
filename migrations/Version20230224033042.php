 ...
 */
final class Version20230224033042 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE schedule ADD CONSTRAINT FK_5A3811FBE8F0C7C7 FOREIGN KEY (compaign_id) REFERENCES compaign (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
